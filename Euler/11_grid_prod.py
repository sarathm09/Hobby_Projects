...
def maxi():
	...
	for i in xrange(0, 20):
		for j in xrange(0, 20):
			if i < 17 and j < 17:
				prod = [mat[i][j] * mat[i][j + 1] * mat[i][j + 2] * mat[i][j + 3],	mat[i][j] * mat[i + 1][j] * mat[i + 2][j] * mat[i + 3][j]]
			if i+3 < 20 and j+3 < 20:
					prod.append(mat[i][j] * mat[i+1][j+1] * mat[i+2][j+2] * mat[i+3][j+3])
			if i+3 < 20 and j-3 > -1:
				prod.append(mat[i][j] * mat[i+1][j-1] * mat[i+2][j-2] * mat[i+3][j-3])
